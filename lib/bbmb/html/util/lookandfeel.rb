...
Beste Grüsse. Virbac Schweiz AG
      ...
      :show_vat                 =>  "inkl. MwSt.",
      :subheader_promotion0     =>  "Produkte-Promotionen (",
      :subheader_promotion1     =>  ")",
      :subheader_sale0          =>  "Produkte-Aktionen (",
      :subheader_sale1          =>  ")",
...
<li> sur demande le vendredi par express, sera livrée samedi matin 
     jusqu’à 9 h (frais de port en charge du client) </li></ul>
      ...
      :history_turnover0        =>  "Chiffre d'affaires total ",
      :history_turnover1        =>  "",
      :html_title               =>  "BBMB",
...
un jour ouvrable. Meilleures salutations. Virbac Suisse SA
      ...
      :show_vat                 =>  "incl. TVA",
      :subheader_promotion0     =>  "Promotions de produit (",
      :subheader_promotion1     =>  ")",
      :subheader_sale0          =>  "Actions de produit (",
      :subheader_sale1          =>  ")",
